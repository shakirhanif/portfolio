  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
      <div className=' max-w-[1240px] px-2 py-16 w-full '>
        <p className=' text-xl uppercase tracking-widest text-[#5651e5] '>Conatact</p>
        <h2 className=' py-4 '>Get In Touch:</h2>
        <div className=' grid lg:grid-cols-5 '>
            <div className=' col-span-3 lg:col-span-2 shadow-xl shadow-gray-400 rounded-xl p-4 '>
                <div className=' lg:p-4 h-full '>
                    <div>
                        <img src="/assets/get_in_touch_2.jpg" alt="" className=' rounded-xl hover:scale-105 ease-in duration-300 ' />
                    </div>
                    <div>
                        <h2 className=' py-2 '>Shakir Hanif</h2>
                        <p>Full Stack Web Developer</p>
                        <p className=' py-2 '>I'm available for freelance or full-time position. Contact me and have a chat.</p>
                    </div>
                    <div>
        ...
        <div className='flex justify-center py-12'>
            <Link href='/'>
                <div className='mx-4 rounded-full shadow-lg shadow-gray-500 p-3 cursor-pointer hover:scale-105 ease-in duration-200'>
                    <HiOutlineChevronDoubleUp className=' m-auto text-[#5651e5] ' size={25}></HiOutlineChevronDoubleUp>
                </div>
            </Link>
        </div>
      </div>
