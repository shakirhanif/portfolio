...
const ProjectCard = ({ img_src, img_alt, title, desc, url, techs }) => {
  return (
    <div>
      <div className=" flex flex-col rounded-md shadow-2xl shadow-gray-700 hover:translate-y-[-1.05rem] ease-in duration-100 hover:bg-[#d4f7f6] hover:shadow-[#36a19e] hover:cursor-default ">
